...
export function ChildAdolescentHighlight() {
  return (
    ...
    >
      <Container className="grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] lg:items-center">
        <div className="max-w-2xl">
          ...
          <h2
            ...
            className="mt-3 font-serif text-[clamp(1.75rem,3vw,2.35rem)] text-white"
          >
          ...
          <div className="mt-8">
            <ButtonLink href={homeChildAdolescent.href} variant="inverse">
        ...
        <div
          className="border-white/20 bg-white/10 rounded-[var(--radius-xl)] border p-6 backdrop-blur-[2px] md:p-8"
          aria-hidden="true"
        >
